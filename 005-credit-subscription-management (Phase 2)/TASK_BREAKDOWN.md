...
- **Depends On**: What must exist first (e.g., Database tables, Backend services)
- **Related**: Connected tasks in other areas (bidirectional)
- **Test Coverage**: Which test validates this task
...
**Spec Reference**: P1 User Story 1 - View Subscription Status & Interview Allocation

#### Subtask 1.1: Create Subscription Status Card Component

- **Spec Reference**: P1 User Story 1, Scenario 1
...
- **Depends On**: Backend 1.8 (GET /api/subscriptions/status endpoint)
- **Test Coverage**: Testing 3.1
...
- **Spec Reference**: P1 User Story 1, Scenarios 3-4
...
- **Depends On**: Backend 1.1 (SubscriptionService)
- **Test Coverage**: Testing 3.1
...
- **Spec Reference**: P1 User Story 1, Scenario 5
...
- **Depends On**: Backend 1.6 (AccountBalanceService)
- **Test Coverage**: Testing 3.1
...
- **Spec Reference**: P1 User Story 1
...
- **Spec Reference**: P1 User Story 1, User Story 5
...
**Spec Reference**: P1 User Story 2 - View Interview Usage History & Analytics

#### Subtask 2.1: Create Line Graph for Usage Over Time

- **Spec Reference**: P1 User Story 2, Scenarios 1-2
...
- **Depends On**: Backend 5.1 (GET /api/usage/timeseries endpoint)
- **Test Coverage**: Testing 3.2
...
- **Spec Reference**: P1 User Story 2, Scenario 3
...
- **Depends On**: Backend 5.2 (GET /api/usage/breakdown endpoint)
- **Test Coverage**: Testing 3.2
...
- **Spec Reference**: P1 User Story 2, Scenario 4
...
- **Spec Reference**: P1 User Story 2, Scenario 5
...
- **Spec Reference**: P1 User Story 2
...
**Spec Reference**: P1 User Story 3 - View Billing History & Invoices

#### Subtask 3.1: Create Billing History Table Component

- **Spec Reference**: P1 User Story 3, Scenario 1
...
- **Spec Reference**: P1 User Story 3, Scenario 2
...
- **Spec Reference**: P1 User Story 3, Scenario 3
...
- **Spec Reference**: P1 User Story 3, Scenario 5
...
**Spec Reference**: P1 User Story 5 - Purchase Individual Interviews

#### Subtask 4.1: Create Purchase Interview Modal

- **Spec Reference**: P1 User Story 5, Scenarios 1-2
...
- **Spec Reference**: P1 User Story 5, Scenario 5
...
- **Spec Reference**: P1 User Story 5, Scenario 2
...
- **Spec Reference**: P1 User Story 5, Scenario 3
...
- **Spec Reference**: P1 User Story 5, Scenario 4
...
**Spec Reference**: FR-013, FR-014, FR-015

#### Subtask 5.1: Create Plan Upgrade Modal

- **Spec Reference**: P1 User Story 5 (quota exhaustion options), FR-013
...
**Spec Reference**: FR-001, FR-027, FR-028, FR-029, FR-030, FR-033
...
- **Related**: Backend 1.8 (API endpoint), Frontend 1.1, Frontend 1.2
- **Test Coverage**: Testing 1.1
...
- **Depends On**: Database 1.2 (CompanySubscription table), Database 1.3 (QuotaReservation table)
- **Related**: Backend 1.9 (API endpoint)
- **Test Coverage**: Testing 1.2, Testing 2.2
...
- **Depends On**: Backend 1.2 (QuotaReservation must exist)
- **Test Coverage**: Testing 1.2
...
- **Depends On**: Backend 1.2 (QuotaReservation entity)
- **Test Coverage**: Testing 1.2
...
- **Spec Reference**: FR-010, P1 User Story 5, Scenario 6
...
- **Spec Reference**: FR-023, FR-032, FR-033, P1 User Story 5, Scenario 1
...
- **Related**: Backend 1.12 (API endpoint), Feature 001 Interview Module
- **Test Coverage**: Testing 1.2, Testing 3.5
...
#### Subtask 1.8: API - GET /api/subscriptions/status
...
- **Test Coverage**: Testing 2.1, Testing 3.1
...
#### Subtask 1.9: API - POST /api/quota/reserve

- **Spec Reference**: FR-027, FR-030
- **Description**: API endpoint to reserve interview quota when HR sends invitation
- **Depends On**: Backend 1.2 (QuotaReservationService)
- **Related**: Feature 001 Interview Module
- **Test Coverage**: Testing 2.2
...
**Spec Reference**: FR-008, FR-009, FR-016, FR-017, FR-025

#### Subtask 2.1: Create Purchase Request Handler

- **Spec Reference**: FR-008, FR-016, P1 User Story 5, Scenario 2
...
- **Spec Reference**: FR-017, P1 User Story 5, Scenario 3
...
- **Spec Reference**: FR-009, P1 User Story 5, Scenario 4
...
- **Related**: Backend 3.2, Backend 3.3
- **Test Coverage**: Testing 2.4
...
- **Spec Reference**: FR-013, P1 User Story 5 (quota exhaustion option 1)
...
- **Depends On**: Backend 3.1 (prorated calculator)
- **Test Coverage**: Testing 2.4
...
**Spec Reference**: FR-004, FR-005, FR-024, FR-026

#### Subtask 4.1: Create Billing Transaction Service

- **Spec Reference**: FR-024
...
- **Related**: Frontend 3.1, Frontend 3.2
- **Test Coverage**: Testing 2.5
...
- **Related**: Frontend 2.1
- **Test Coverage**: Testing 2.6
...
- **Depends On**: Backend 5.1, Backend 5.2
- **Related**: Frontend 2.3
- **Test Coverage**: Testing 2.6
...
**Spec Reference**: FR-011, FR-012, FR-018, P2 User Story 4 - Receive Interview Quota Alerts

#### Subtask 6.1: Create Notification Trigger Service

- **Spec Reference**: FR-011, FR-012, P2 User Story 4, Scenarios 1-2, 4-5
...
- **Depends On**: Database 2.4 (NotificationLog table)
- **Test Coverage**: Testing 2.7
...
- **Spec Reference**: FR-011, FR-018, P2 User Story 4, Scenarios 1, 3, 6
...
- **Spec Reference**: P2 User Story 4, Scenario 2
...
- **Related**: Frontend 1.2, Frontend 1.3
- **Test Coverage**: Testing 2.7
...
- **Spec Reference**: P2 User Story 4, Scenarios 6-8
...
- **Spec Reference**: P2 User Story 4, Scenario 5
...
- **Related**: Frontend 6.1, Frontend 6.2
- **Test Coverage**: Testing 2.8
...
**Spec Reference**: FR-001, FR-027, FR-028, FR-029, FR-030
...
- **Related**: Backend 1.2, Backend 1.3, Backend 1.4
- **Test Coverage**: Testing 1.2
- **Columns**:
  - `id` (PK, INT)
...
**Spec Reference**: FR-004, FR-008, FR-017, FR-024, FR-031

#### Subtask 2.1: Create BillingTransaction Table

- **Spec Reference**: FR-004, FR-024, P1 User Story 3
- **Description**: Create table to store all financial transactions with comprehensive audit trail
- **Related**: Backend 4.1, Backend 4.2, Backend 4.4
- **Test Coverage**: Testing 2.5
- **Columns**:
  - `id` (PK, INT)
  - `company_id` (FK to companies)
...
- **Related**: Backend 7.1, Backend 7.2
- **Test Coverage**: Testing 2.8
- **Columns**:
  - `id` (PK, INT)
  - `company_id` (FK to companies)
...
**Spec Reference**: FR-004, FR-006, FR-022
...
- **Spec Reference**: Development data setup
...
### Main Task 8: Invoice PDF Generation

**Description**: Implement PDF invoice generation using template engine and PDF library.

**Spec Reference**: FR-005, FR-026

#### Subtask 8.1: Set Up PDF Generation Library
...
#### Subtask 8.2: Create Invoice HTML Template
...
#### Subtask 8.3: Implement PDF Generation Service
...
#### Subtask 8.4: Implement PDF Caching Strategy
...
#### Subtask 9.1: Generate Unique Reference Codes
...
#### Subtask 9.2: Create Payment Instructions Generator
...
#### Subtask 9.3: Implement Receipt Upload Handler
...
#### Subtask 9.4: Create Admin Payment Verification Interface (Backend)
...
#### Subtask 9.5: Implement Payment Approval Webhook (Future Enhancement)
...
### Main Task 10: Email Notification System
...
**Spec Reference**: FR-011, FR-018, P2 User Story 4 - Receive Interview Quota Alerts

#### Subtask 10.1: Set Up Email Service Provider Integration
...
#### Subtask 10.2: Create Email Template Engine
...
#### Subtask 10.3: Create Quota Alert Email Templates

- **Spec Reference**: P2 User Story 4, Scenarios 1, 3
...
#### Subtask 10.4: Create Balance Alert Email Template

- **Spec Reference**: P2 User Story 4, Scenario 6
...
#### Subtask 10.5: Create Payment Confirmation Email Templates

- **Spec Reference**: FR-018
...
#### Subtask 10.6: Implement Batch Email Sending for Company Admins
...
### Main Task 11: In-App Notification System

**Description**: Implement in-app banner and modal notification system for real-time alerts.

**Spec Reference**: P2 User Story 4 - Receive Interview Quota Alerts

#### Subtask 11.1: Create Notification Queue Service
...
#### Subtask 11.2: Implement Notification Fetch Endpoint
...
#### Subtask 11.3: Implement Notification Acknowledgment Endpoint
...
#### Subtask 11.4: Create WebSocket/Polling for Real-Time Notifications (Optional Enhancement)
...
### Main Task 12: Scheduled Notification Jobs

**Description**: Implement background jobs to check thresholds and trigger notifications.

**Spec Reference**: FR-011, FR-012, P2 User Story 4 - Receive Interview Quota Alerts

#### Subtask 12.1: Create Quota Threshold Checker Job

- **Spec Reference**: FR-011, FR-012, P2 User Story 4, Scenarios 1, 3, 4
...
#### Subtask 12.2: Create Balance Threshold Checker Job

- **Spec Reference**: P2 User Story 4, Scenarios 6, 7, 8
...
#### Subtask 12.3: Create Notification Flag Reset Job
...
#### Subtask 12.4: Implement Job Scheduler Configuration
...
- **Spec Reference**: FR-027, FR-028, FR-029, P1 User Story 5
- **Description**: Write unit tests for quota reservation, settlement, and release methods
- **Covers**: Backend 1.2, Backend 1.3, Backend 1.4, Backend 2.4
- **Test Cases**:
...
#### Subtask 1.3: Test Account Balance Service

- **Spec Reference**: FR-030, FR-032
- **Description**: Write unit tests for balance tracking and operations
- **Covers**: Backend 1.6, Backend 7.3
- **Test Cases**:
  - Test balance reservation and release
  - Test balance deduction on settlement
  - Test available balance calculation (total - reserved)
  - Test balance credit on top-up
  - Test audit trail creation
- **Coverage Target**: > 90%
- **Files**: `tests/unit/services/AccountBalanceService.test.js`

#### Subtask 1.4: Test Billing Service Methods

- **Spec Reference**: FR-004, FR-024, P1 User Story 3
- **Description**: Write unit tests for billing transaction creation and invoice generation
- **Covers**: Backend 4.1, Backend 4.2, Backend 4.3, Backend 4.4
- **Test Cases**:
...
#### Subtask 1.5: Test Notification Service Logic

- **Spec Reference**: FR-011, FR-012, P2 User Story 4
- **Description**: Write unit tests for notification triggers and duplicate prevention
- **Covers**: Backend 6.1, Backend 6.2, Backend 6.4, Backend 6.5
- **Test Cases**:
...
#### Subtask 1.6: Test Prorated Charge Calculator
...
#### Subtask 1.7: Test Database Seed Scripts

- **Spec Reference**: FR-001
- **Description**: Write tests to validate seed scripts run correctly
- **Covers**: Database 6.1, Database 6.2
- **Test Cases**:
  - Test subscription plans seeded correctly
  - Test idempotency (running seed twice doesn't create duplicates)
  - Test test data creates realistic scenarios
- **Coverage Target**: > 85%
- **Files**: `tests/unit/seeds/subscriptionPlans.test.js`
...
**Spec Reference**: All P1 User Stories

#### Subtask 2.1: Test Subscription Management Endpoints

- **Spec Reference**: P1 User Story 1, FR-013, FR-014, FR-015
- **Description**: Write integration tests for subscription API endpoints
- **Covers**: Backend 1.8, Backend 3.2, Backend 3.3, Backend 3.4
- **Test Cases**:
...
- **Covers**: Backend 1.9, Backend 1.7
- **Test Cases**:
...
- **Spec Reference**: FR-008, FR-016, FR-017, FR-031, P1 User Story 5
- **Description**: Write integration tests for individual purchase and balance top-up endpoints
- **Covers**: Backend 2.1, Backend 2.2, Backend 7.1, Backend 7.2
- **Test Cases**:
...
#### Subtask 2.4: Test Subscription Change Endpoints

- **Spec Reference**: FR-013, FR-014, FR-015
- **Description**: Write integration tests for subscription upgrade/downgrade/cancellation
- **Covers**: Backend 3.2, Backend 3.3, Backend 3.4
- **Test Cases**:
  - POST /api/subscriptions/upgrade with prorated charge
  - POST /api/subscriptions/downgrade with quota validation
  - POST /api/subscriptions/cancel with refund calculation
- **Coverage Target**: > 85%
- **Files**: `tests/integration/api/subscription-changes.test.js`

#### Subtask 2.5: Test Billing History Endpoints

- **Spec Reference**: FR-004, FR-005, FR-006, P1 User Story 3
...
#### Subtask 2.6: Test Usage Analytics Endpoints

- **Spec Reference**: P1 User Story 2, FR-022
- **Description**: Write integration tests for usage analytics data endpoints
- **Covers**: Backend 5.1, Backend 5.2, Backend 5.3, Backend 5.4
- **Test Cases**:
...
#### Subtask 2.7: Test Notification Endpoints

- **Spec Reference**: FR-011, FR-012, P2 User Story 4
- **Description**: Write integration tests for notification system
- **Covers**: Backend 6.1, Backend 6.2, Backend 6.3
- **Test Cases**:
  - Test quota threshold checker triggers notifications
  - Test balance threshold checker triggers notifications
  - GET /api/notifications/unread returns pending notifications
  - POST /api/notifications/:id/acknowledge marks as read
- **Coverage Target**: > 85%
- **Files**: `tests/integration/api/notifications.test.js`

#### Subtask 2.8: Test Balance Top-Up Workflow

- **Spec Reference**: FR-031
- **Description**: Write integration tests for balance top-up process
- **Covers**: Backend 7.1, Backend 7.2, Backend 7.3
- **Test Cases**:
  - POST /api/balance/topup creates request
  - Admin approval credits balance correctly
  - Minimum amount validation (RM50)
- **Coverage Target**: > 85%
- **Files**: `tests/integration/api/topup.test.js`
...
- **Spec Reference**: P1 User Story 1
- **Description**: E2E test for viewing subscription status and usage
- **Covers**: Frontend 1.1, Frontend 1.2, Frontend 1.3, Backend 1.8
- **Test Steps**:
...
- **Spec Reference**: P1 User Story 2
- **Description**: E2E test for viewing and filtering usage charts
- **Covers**: Frontend 2.1, Frontend 2.2, Frontend 2.3, Backend 5.1, Backend 5.2
- **Test Steps**:
  1. Login as Company Admin
...
- **Spec Reference**: P1 User Story 3
- **Description**: E2E test for viewing billing history and downloading invoices
- **Covers**: Frontend 3.1, Frontend 3.2, Frontend 3.3, Backend 4.4
- **Test Steps**:
  1. Login as Company Admin
...
- **Spec Reference**: P1 User Story 5
- **Description**: E2E test for purchasing individual interviews
- **Covers**: Frontend 4.1, Frontend 4.3, Frontend 4.4, Backend 2.1, Backend 2.2
- **Test Steps**:
...
- **Spec Reference**: P1 User Story 5, FR-013
- **Description**: E2E test for quota exhaustion blocking and subscription upgrade
- **Covers**: Frontend 5.1, Backend 1.7, Backend 3.2
- **Test Steps**:
...
- **Total Main Tasks**: 26 (Backend now includes Invoice PDF Generation, Bank Transfer Payment Processing, Email Notifications, In-App Notifications, and Scheduled Notification Jobs)
- **Total Subtasks**: 141+
...
- **Frontend**: 6 main tasks
- **Backend**: 12 main tasks (includes service logic, API endpoints, invoice generation, payment processing, and notifications)
- **Database**: 2 main tasks
- **Testing**: 3 main tasks
- **DevOps**: 3 main tasks

**Cross-Referencing Notes**:

- All Frontend tasks reference Backend APIs they depend on (Depends On field)
- Backend service methods and API endpoints are combined in the same main tasks
- All Database tables show which Backend services use them (Related field)
- All implementation tasks link to test tasks that validate them (Test Coverage field)
